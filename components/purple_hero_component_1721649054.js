Vue.component("purple_hero_component_1721649054", {
    template: `
            ...
            <div id="hero-content-container" class="pt-32 pb-16 md:pt-52 md:pb-32">
                ...
                <div id="hero-content" class="max-w-3xl mx-auto text-center" style="position: relative; z-index: 1">
                    ...
                    <div class="flex" id="hero-text-container">
                        <h1 id="hero-text" class="h1 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4" data-aos="fade-down">Unlock the Power of Blockchain Analysis</h1>
                    </div>
                    <div class="flex" id="sub-hero-text-container">
                        <p id="sub-hero-text" class="flex-1 text-lg mb-8 text-slate-300" data-aos="fade-down" data-aos-delay="200">Our cutting-edge platform provides deep insights into emerging blockchain networks, empowering you to stay ahead of the curve.</p>
                    </div>
