...
Vue.component("purple_feature_grid_component_1721649283", {
    template: `
    <!-- Features list -->
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
        ...
        <div id="feature-1">
            ...
            <div class="flex" id="feature-1-description-container"><p id="feature-1-description" class="flex-1 text-sm">Stay ahead of the curve by exploring and understanding new blockchain networks as they emerge. Our platform provides tools to quickly ingest and analyze data from cutting-edge blockchains.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-2">
            ...
            <div class="flex" id="feature-2-description-container"><p id="feature-2-description" class="flex-1 text-sm">Uncover hidden patterns, trends, and opportunities within blockchain data. Our advanced analytics capabilities enable you to derive actionable insights from complex on-chain activity.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-3">
            ...
            <div class="flex" id="feature-3-description-container"><p id="feature-3-description" class="flex-1 text-sm">Gain a comprehensive view of a blockchain's performance, security, and reliability. Monitor key metrics like transaction throughput, node distribution, and consensus participation.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-4">
            ...
            <div class="flex" id="feature-4-description-container"><p id="feature-4-description" class="flex-1 text-sm">Tailor the ingestion, transformation, and delivery of blockchain data to meet your specific needs. Build flexible pipelines that integrate seamlessly with your existing infrastructure.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-5">
            ...
            <div class="flex" id="feature-5-description-container"><p id="feature-5-description" class="flex-1 text-sm">Our platform is built with a decentralized, secure, and highly scalable architecture, ensuring reliable access to blockchain data as your needs grow.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-6">
            ...
            <div class="flex" id="feature-6-description-container"><p id="feature-6-description" class="flex-1 text-sm">Join a vibrant community of developers, researchers, and enthusiasts exploring the frontiers of blockchain technology. Share knowledge, contribute tools, and drive innovation together.</p></div>
        </div>
    </div>`,
        data() {
            return {
